...
# extract-releases.js generates an intermediary file with a comma separated list of the releases and their md5 sums
# generated by scrapping plugins.xml file
# This script goes through all the files in the csv, downloads the release from release_url,
# calculates the MD5 sum, and compare it to the expected md5 hash
